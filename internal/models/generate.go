...
func step1() {
	dir, err := os.ReadDir("internal/models/tplibrary")
	if err != nil {
	...
	for _, file := range dir {
		...
		bytes, err := os.ReadFile("internal/models/tplibrary/" + file.Name())
		if err != nil {
...
func step2() {
	...
	for _, file := range dir {
		...
		err = os.WriteFile("internal/models/tplibrary/"+file.Name(), bytes, 0644)
		if err != nil {
			log.Fatalf("error writing file: %s", err.Error())
		}
	}
